...
const AboutUs = () => {
  return <section id="about" className="py-8 sm:py-12 md:py-16 lg:py-20 bg-neutral-50 overflow-hidden">
      <div className="container mx-auto max-w-7xl px-3 sm:px-4 md:px-6 lg:px-8">
        ...
        <div className="mb-8 sm:mb-12 md:mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {values.map((value, index) => <div key={index} className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-neutral-100 hover:shadow-md hover:border-amber-200 transition-all duration-300 animate-fade-in" style={{
